...
def test_live_py(currency, live_GenericCompound_usdc_1, live_GenericCream_usdc_1, live_GenericDyDx_usdc_1, live_vault_usdc, live_strat_usdc_1, Strategy, samdev):
