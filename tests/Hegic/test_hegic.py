...
def test_normal_hegic(hegic,Strategy, crHegic, chain, whale,gov,strategist,rando,vault, strategy, fn_isolation):
...
def test_apr_hegic(weth,strategy,crUsdc, crComptroller,usdc, crHegic, vault, hegic, chain,rewards, whale,gov,strategist,rando,Vault, interface,AlphaHomo, EthCream, EthCompound):
